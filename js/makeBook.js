...
function makeBooks(bookObject) { 
        ...
        textContainer.bookId = bookObject.id;
        ...
        buttonContainer.classList.add("action");
         ...
         buttonContainer.append(createNotFinishedButton("Tandai Telah Dibaca",bookObject.id), createYellowButton("Rubah", bookObject.id), createRedButton("Hapus",bookObject.id));
        ...
        const buttonContainer =  document.createElement("div");
        buttonContainer.classList.add("action");
         buttonContainer.append(createFinishedButton("Tandai Belum Dibaca",bookObject.id), createYellowButton("Rubah", bookObject.id), createRedButton("Hapus",bookObject.id));
         // Append action buttons to the container
        textContainer.append(buttonContainer);
...
const createYellowButton = (text,bookId) => {
    const button = createButton("yellow", (e) => {
        getBook(bookId);
    }, text);
